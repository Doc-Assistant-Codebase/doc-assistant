...
import com.doc.assistant.dao.impl.PatientDaoImpl;
...
//		
		...
		Patient patient1 = patientService.findById(new Integer(2));
		System.out.println(patient1.getFirstName());
		
		Patient patient2 = patientService.searchByName("Pranab");
		System.out.println(patient2.getFirstName());
...
//		patientService.deletePatient(new Integer(7));
		
//		Patient pat = new Patient();
//
//		pat.setFirstName("Elon");
//		patientService.updatePatient(4, pat);
